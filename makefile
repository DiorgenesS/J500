...
local-pre-zip-misc:
	...
	$(hide) rm -rf $(ZIP_DIR)/system/etc/init.d/00fs_test
	$(hide) rm -rf $(ZIP_DIR)/system/etc/init.d/02fs_logcat
	$(hide) rm -rf $(ZIP_DIR)/system/etc/init.d/03fs_zipalign
	$(hide) rm -rf $(ZIP_DIR)/system/etc/init.d/04fs_sqlite
	$(hide) rm -rf $(ZIP_DIR)/system/etc/init.d/05fs_fstrim
